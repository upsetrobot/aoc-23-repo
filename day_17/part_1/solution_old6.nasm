...
section .text
    ...
    getSolution:
        ...
        struc memo
            ...
            .right_path1:           resd    1
            .right_path2:           resd    1
            .right_path0_visited:   resb    1
            .right_path1_visited:   resb    1
            .right_path1_visited:   resb    1
            .right_pad:             resb    1
            ...
            .left_path1:            resd    1
            .left_path2:            resd    1
            .left_path0_visited:    resb    1
            .left_path1_visited:    resb    1
            .left_path2_visited:    resb    1
            .left_pad:              resb    1

            .up_path0:              resd    1
            .up_path1:              resd    1
            .up_path2:              resd    1
            .up_path0_visited:      resb    1
            .up_path1_visited:      resb    1
            .up_path2_visited:      resb    1
            .up_pad:                resb    1

            .down_path0:            resd    1
            .down_path1:            resd    1
            .down_path2:            resd    1
            .down_path0_visited:    resb    1
            .down_path1_visited:    resb    1
            .down_path2_visited:    resb    1
            .down_pad:              resb    1
        ...
        ; mov dword [r11 + memo.right_path0], 0
        ; mov byte [r11 + memo.right_path0_visited], 0
        ; mov dword [r11 + memo.left_path0], 0
        ; mov byte [r11 + memo.left_path0_visited], 0
        ; mov dword [r11 + memo.up_path0], 0
        ; mov byte [r11 + memo.up_path0_visited], 0
        mov dword [r11 + memo.down_path0], 0
        mov byte [r11 + memo.down_path0_visited], 0
                
        ; Do visited loop.
        ; Starting at down_path0.
        .while:
            ; Look up path.
            mov rax, rsi
